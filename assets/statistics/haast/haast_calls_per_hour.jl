...
function get_calls_per_hour()
  ...
  FROM
    tuning_fork_labels_20230907 AS l
  RIGHT OUTER JOIN
    (SELECT * FROM tuning_fork_files) AS f
  ON
...
something.(description, missing) |> CSV.write("./_assets/statistics/tableinput/haast_calls_per_hour_description.csv")
...
save("./_assets/statistics/haast_calls_per_hour_aggregate.svg", W)
...
save("./_assets/statistics/haast_calls_per_hour.svg", X)