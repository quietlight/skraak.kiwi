...
function graph_data()
  ...
  CSV.write("./_assets/statistics/tableinput/haast_calls_per_hour_by_location.csv", df)
...
save("./_assets/statistics/haast_calls_per_hour_by_location.svg", X)