...
function get_loc_list()
  ...
  m=mean(df2.individual)
  sd=std(df2.individual)
  @transform!(df2, @byrow :colour = :individual >= m ? "red" : (:individual < m-sd ? "blue" : "orange"))
...
save("./_assets/statistics/calls_per_hour_by_location_map.png", X)